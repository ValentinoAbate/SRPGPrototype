...
public static class Vector2IntUtils
{
    ...
    public static IEnumerable<Vector2Int> UniqueWithSelector(IEnumerable<Vector2Int> positions, System.Func<Vector2Int, Vector2Int> selector, System.Predicate<Vector2Int> pred = null)
    {
